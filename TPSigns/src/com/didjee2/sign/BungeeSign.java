			...
			if(location.getWorld().getChunkAt(location).isLoaded())
			{
				...
				if(b.getState() instanceof Sign)
				{
					if(server != null)
					{
						...
						{
							Sign sign = (Sign)b.getState();
							TPSigns.getInstance().logConsole(Level.WARNING, "[TPSigns] Can't find layout '" + this.layout + "'.");
					...
					{
						Sign sign = (Sign)b.getState();
						TPSigns.getInstance().logConsole(Level.WARNING, "[TPSigns] Can't find server '" + this.server + "'.");
