...
public class SignLayout {
	...
	public SignLayout(String name, String online, String offline, List<String> lines, boolean teleport, String offlineInt, String offlineMotd, String offlineMessage, String cooldownMessage, HashMap<String, Byte> map){
	    this.name = name;
	    this.online = online;
